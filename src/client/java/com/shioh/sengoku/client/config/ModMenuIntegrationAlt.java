 ...
 */
public class ModMenuIntegrationAlt implements ModMenuApi {
    ...
    private static Screen createConfigScreen(Screen parent) {
        com.shioh.sengoku.config.SengokuConfig config = com.shioh.sengoku.config.SengokuConfig.getInstance();
        ...
        // Yuki Onna Category
        ConfigCategory spawningCategory = builder.getOrCreateCategory(
            Component.literal("Spawning"));
        
        // Check interval is fixed; spawning enabled toggle available below.
        spawningCategory.addEntry(entryBuilder.startBooleanToggle(
        ...
        spawningCategory.addEntry(entryBuilder.startDoubleField(
        ...
        miscCategory.addEntry(entryBuilder.startDoubleField(
            ...
            .setMin(0.0)
            .setMax(64.0)
            .setTooltip(Component.literal("Radius in blocks for nearby boars to be alerted. Default: 16.0"))
        ...
        miscCategory.addEntry(entryBuilder.startIntField(
            ...
            .setMin(0)
            .setMax(2000)
            .setTooltip(Component.literal("How long (ticks) boars will keep retaliating. Default: 200"))
        ...
        miscCategory.addEntry(entryBuilder.startBooleanToggle(
            ...
            .setDefaultValue(true)
            .setTooltip(Component.literal("Enable or disable yokai avoiding Shide blocks. Default: enabled"))
        ...
        visualsCategory.addEntry(entryBuilder.startIntSlider(
            ...
            .setDefaultValue(38)
            .setTooltip(Component.literal("Maximum spawn radius for the larger fog particles during mist weather. Higher values spread fog farther out."))
