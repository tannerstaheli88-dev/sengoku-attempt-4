...
public class OmukadeModel extends HierarchicalModel<OmukadeEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
        ResourceLocation.fromNamespaceAndPath("sengoku", "omukade"),
        "main"
    );
    ...
    public OmukadeModel(ModelPart root) {
        this.root = root;
    ...
    @Override
    public void setupAnim(OmukadeEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
