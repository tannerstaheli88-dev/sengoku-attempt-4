...
/**
 * Simple Kojin model with editable boxes for ETF CEM.
 */
public class KojinModel extends EntityModel<KojinEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("sengoku", "kojin"), "main");
    ...
    public KojinModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(KojinEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
