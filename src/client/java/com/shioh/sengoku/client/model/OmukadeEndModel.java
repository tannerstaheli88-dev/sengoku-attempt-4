...
/**
 * Standalone model for OmukadeEndEntity.
 * Geometry/animation matches OmukadePartModel but uses its own layer namespace.
 */
public class OmukadeEndModel extends HierarchicalModel<OmukadeEndEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
        ResourceLocation.fromNamespaceAndPath("sengoku", "omukade_end"),
        "main"
    );
    ...
    public OmukadeEndModel(ModelPart root) {
        this.root = root;
    ...
    @Override
    public void setupAnim(OmukadeEndEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.root().xRot = 0.0F;
        this.root().yRot = 0.0F;
        this.root().zRot = 0.0F;
        this.head.yRot = 0.0F;
