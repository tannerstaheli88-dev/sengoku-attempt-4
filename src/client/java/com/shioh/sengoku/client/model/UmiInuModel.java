...
public class UmiInuModel extends EntityModel<UmiInuEntity> {

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
        ResourceLocation.fromNamespaceAndPath("sengoku", "umi_inu"), "main");
    ...
    public UmiInuModel(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild("head", CubeListBuilder.create()
            .texOffs(0, 0).addBox(-5.0F, -6.0F, -5.0F, 10, 10, 10),
            PartPose.offset(0.0F, -2.0F, 0.0F));

        root.addOrReplaceChild("body", CubeListBuilder.create()
            .texOffs(0, 20).addBox(-6.0F, 0.0F, -3.0F, 12, 10, 6),
            PartPose.offset(0.0F, 0.0F, 0.0F));

        root.addOrReplaceChild("left_fin", CubeListBuilder.create()
            .texOffs(48, 0).addBox(0.0F, 0.0F, -1.0F, 8, 1, 6),
            PartPose.offset(6.0F, 2.0F, 0.0F));

        root.addOrReplaceChild("right_fin", CubeListBuilder.create()
            .texOffs(48, 0).mirror().addBox(-8.0F, 0.0F, -1.0F, 8, 1, 6),
            PartPose.offset(-6.0F, 2.0F, 0.0F));

        root.addOrReplaceChild("tail", CubeListBuilder.create()
            .texOffs(48, 8).addBox(-2.0F, 0.0F, 0.0F, 4, 8, 2),
    ...
    @Override
    public void setupAnim(UmiInuEntity entity, float limbSwing, float limbSwingAmount,
