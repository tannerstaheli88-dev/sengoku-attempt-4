...
/**
 * Takeda Ashigaru - Exact copy of Pillager but attacks other clans and shoots spectral arrows.
 */
public class TakedaAshigaruEntity extends Pillager {
    
    public TakedaAshigaruEntity(EntityType<? extends Pillager> type, Level level) {
        super(type, level);
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(4, new NearestAttackableTargetGoal<>(this, Pillager.class, 10, true, false, (target) -> !(target instanceof TakedaAshigaruEntity)));
        ...
        this.targetSelector.addGoal(4, new NearestAttackableTargetGoal<>(this, net.minecraft.world.entity.monster.Evoker.class, 10, true, false, (target) -> !(target instanceof TakedaSoheiEntity)));
    }
