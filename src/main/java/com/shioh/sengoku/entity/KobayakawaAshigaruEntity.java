...
/**
 * Kobayakawa Ashigaru - Exact copy of Pillager but attacks other clans and shoots spectral arrows.
 */
public class KobayakawaAshigaruEntity extends Pillager {
    
    public KobayakawaAshigaruEntity(EntityType<? extends Pillager> type, Level level) {
        super(type, level);
    ...
    protected void registerGoals() {
        // DON'T call super.registerGoals() - we need to override vanilla targeting completely
        
        // Copy vanilla Pillager goals but WITHOUT the ones that target other illagers
        ...
        // Target only OTHER clans (not Kobayakawa) and players
        ...
        this.targetSelector.addGoal(4, new NearestAttackableTargetGoal<>(this, net.minecraft.world.entity.monster.Vindicator.class, 10, true, false, (target) -> !(target instanceof KobayakawaSamuraiEntity)));
        this.targetSelector.addGoal(4, new NearestAttackableTargetGoal<>(this, net.minecraft.world.entity.monster.Evoker.class, 10, true, false, (target) -> !(target instanceof KobayakawaSoheiEntity)));
    }
